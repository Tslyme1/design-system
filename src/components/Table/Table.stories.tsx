    ...
    docs: {
      description: {
        component: [
          ...
          'Анатомия: caption / thead → th × N / tbody → tr → td × N / TableSummary?. `caption` обязателен: таблица без названия не читается в списке заголовков скринридера. Если название уже стоит рядом — заголовком раздела или подписью панели, — его убирают с экрана пропом `captionHidden`, а не выбрасывают из разметки.',
...
/** Четыре формы: только чтение, с сортировкой, с переходом по строке и итогом, без видимого названия. */
