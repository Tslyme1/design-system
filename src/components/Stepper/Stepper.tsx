...
export type Step = {
   ...
   * ниже) и складываются: у текущего завершённого шага — галка и
   * усиленная обводка (обычно у `active`), но без заливки `done`:
   * сплошной цвет читался бы как «шаг позади», а он ещё активен.
   */
  completed?: boolean;
};
