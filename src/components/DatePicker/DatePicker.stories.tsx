...
export const Content: Story = {
  ...
  render: () => (
    <Stack gap="xl" align="start">
      ...
      <Text variant="bodySm" color="textMuted">
        Поле — настоящий `input`: дату можно напечатать («21.08.2026»), не только выбрать в сетке. Печать
        подтверждается по Enter или уходом с поля; нераспознанный или вне границ `min`/`max` текст откатывается
        к последнему настоящему значению, а не принимается молча.
      </Text>
    </Stack>
  ),
};
